...
var getServerDb = () => {
  try {
    ...
    const app2 = isInitialized ? (0, import_app.getApp)("serverApp") : (0, import_app.initializeApp)(firebaseConfig, "serverApp");
    const db = isInitialized ? (0, import_firestore.getFirestore)(app2, "ai-studio-6180126a-591b-4f63-b44a-d513c9233feb") : (0, import_firestore.initializeFirestore)(app2, { experimentalAutoDetectLongPolling: true }, "ai-studio-6180126a-591b-4f63-b44a-d513c9233feb");
    return db;
  } catch (err) {
